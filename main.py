...
def create_comp_graph():
    ...
    start_node1 = DataSourceNode(name="start_node1", processing_function=None, data_source='log1.txt')
    start_node2 = DataSourceNode(name="start_node2", processing_function=None, data_source='log2.txt')
    start_node3 = DataSourceNode(name="start_node3", processing_function=None, data_source='log3.txt')
